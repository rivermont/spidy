...
def setup_window():
	...
	settingBox = ttk.Frame(mainFrame, padding='4', borderwidth=1, relief='solid')
	...
	rightBar = ttk.Frame(mainFrame, padding='4', borderwidth=1, relief='solid')
	...
	controlBox = ttk.Frame(rightBar, padding='4', borderwidth=1, relief='solid')
	...
	statusBox = ttk.Frame(rightBar, padding='4', borderwidth=1, relief='solid')
	...
	consoleBox = ttk.Frame(rightBar, padding='4', borderwidth=1, relief='solid')
	...
	pauseButton = ttk.Button(controlBox, padding='4', text='Pause')
	...
	goButton = ttk.Button(controlBox, command=start_crawler, padding='4', text='Go')
	...
	stopButton = ttk.Button(controlBox, padding='4', text='Stop')
