...
from spidy.crawler import PACKAGE_DIR, main
...
def setup_window():
    ...
    ttk.Label(setting_box, text="Crawler Settings").grid(
        column=0, row=0, columnspan=4, sticky=(N, S)
    )
    ...
    raise_errors_check = ttk.Checkbutton(
        setting_box, text="Raise Errors", variable=raise_errors
    )
    ...
    save_pages_check = ttk.Checkbutton(
        setting_box, text="Save Pages", variable=save_pages
    )
    ...
    zip_files_check = ttk.Checkbutton(
        setting_box, text="Zip Files", variable=zip_files_
    )
    ...
    save_words_check = ttk.Checkbutton(
        setting_box, text="Save Words", variable=save_words
    )
    ...
    ttk.Label(setting_box, text="Save Count").grid(
    ...
    ttk.Label(setting_box, text="Custom Headers").grid(
        column=0, row=8, columnspan=2, sticky=W
    )
    ...
    ttk.Label(setting_box, text="Start Links").grid(
    ...
    max_known_errors_entry = ttk.Entry(
        setting_box, width=4, textvariable=max_known_errors
    )
